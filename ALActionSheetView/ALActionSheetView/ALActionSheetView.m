...
- (instancetype)initWithTitle:(NSString *)title cancelButtonTitle:(NSString *)cancelButtonTitle destructiveButtonTitle:(NSString *)destructiveButtonTitle otherButtonTitles:(NSArray *)otherButtonTitles handler:(ALActionSheetViewDidSelectButtonBlock)block;
{
    ...
    if (self)
    {
        ...
        UIView *titleSeparatorView = [[UIView alloc] initWithFrame:CGRectMake(0, offy, width, kRowLineHeight)];
        titleSeparatorView.backgroundColor = [UIColor colorWithRed:0.0f/255.0f green:195.0f/255.0f blue:225.0f/255.0f alpha:1.0f];
        [_actionSheetView addSubview:titleSeparatorView];
